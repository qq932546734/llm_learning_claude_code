...
### Module 09: 指令微调 (Instruction Tuning)
**目标**: 从预训练模型到可用助手
- 指令数据的构建与多样性
- 多轮对话的格式化与处理
- 灾难性遗忘与缓解策略
...
### Module 11: 对齐的科学 (The Science of Alignment)
**目标**: 理解对齐的本质问题
- 有用性vs无害性权衡
- 奖励黑客与Gaming
...
每完成一个Module，在 [../progress.md](../progress.md) 中更新状态：
- `🔄 Not Started`
- `📖 Reading`
- `💡 Understanding`
- `🔨 Practicing`
